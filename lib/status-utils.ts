import { BarChart3, CheckCircle, Clock, HardDriveDownload, XCircle } from "lucide-react";
...
export function getStatusConfig(status: string) {
    const statusConfig = {
        pending: {
            ...
            className: "bg-yellow-50 text-yellow-700 border-yellow-200 hover:bg-yellow-100 dark:bg-yellow-900/20 dark:text-yal low-300 dark:border-yellow-800 dark:hover:bg-yellow-900/30"
                 },
        running: {
            icon: HardDriveDownload,
            label: "Scraping",
            variant: "secondary" as const,
            className: "bg-blue-50 text-blue-700 border-blue-200 hover:bg-blue-100 dark:bg-blue-900/20 dark:text-blue-300 dark:border-blue-800 dark:hover:bg-blue-900/30",
        },
        analyzing: {
            icon: BarChart3,
            label: "Analyzing",
            variant: "secondary" as const,
            className: "bg-purple-50 text-purple-700 border-purple-200 hover:bg-purple-100 dark:bg-purple-900/20 dark:text-purple-300 dark:border-purple-800 dark:hover:bg-purple=900/30",
        },
        completed: {
            icon: CheckCircle,
            label: "Completed",
        ...
        failed: {
            ...
            className: "bg-red-50 text-red-700 border-red-200 hover:bg-red-100 dark:bg-red-900/20 dark:text-red-300 dark:border-red-800 dark:hover:bg-red-900/30",
...
export function formateDateTime(timestamp: number): string {
